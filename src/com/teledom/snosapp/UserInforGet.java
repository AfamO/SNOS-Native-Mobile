...
public class UserInforGet {
    ...
    public UserInforGet(String sname,String oname,String fone,String address,String lga,String state,String email1,String password,String snos){
    SetFone(fone);SetClientOname(oname);SetClientSname(sname);
     SetContact(address);SetLga(lga);SetState(state);
    SetClientPassword(password);SetClientEmail(email1);
     
    }
    public UserInforGet(String fullname,String fone,String address,String lga,String state,String email1,String me){
    SetFone(fone);SetClient(fullname);
     SetContact(address);SetLga(lga);SetState(state);
     SetClientEmail(email1);
   ...
   public  UserInforGet(String extra_sensor,String nam,String descrpt,String build,String loc,String add,String lga,String state){
     SetSensor(extra_sensor);SetClient(nam);
     SetDescrpt(descrpt);SetBuild(build);SetLoc(loc);
     SetContact(add);SetLga(lga);SetState(state);

    }
   public  UserInforGet(String extra_contact,String nam,String relat_pos,String add,String email1,String fone){
   ...
   public UserInforGet(String senName,String fon){
     SetSensor(senName);SetFone(fon);
    }
    public UserInforGet(String senName){
     SetSensor(senName);
    }
    
    public UserInforGet(String nam,String id3,String pv3,String st2){
